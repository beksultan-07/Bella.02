...
export default function Product({ data }) {
  return (
    <Link to="/productInfo" className={styles.products__list__item} >
      ...
      <div className={styles.products__list__item__desc}>
        <div className={styles.price__info}>
          <div className={styles.price}>
            <p className={styles.price__old}>{data.price} с.</p>
            <p className={styles.price__curr}>{data.price} с.</p>
          </div>
        </div>

        <h4 className={styles.products__list__item__name}>{data.name}</h4>
